    ...
    <section className="min-h-screen text-black mt-8">
      <div className="mx-auto max-w-[1280px] 2xl:max-w-[1600px] px-4 space-y-8">
        ...
        <div className="flex gap-10 flex-col lg:flex-row">
          <div className="flex gap-8 rounded-2xl overflow-hidden p-4 bg-secondary-gradient shadow-2xl flex-1">
          ...
          <div className="lg:w-2/5 space-y-5">
            <div className="bg-secondary-gradient shadow-2xl p-5 rounded-2xl overflow-hidden space-y-5">
