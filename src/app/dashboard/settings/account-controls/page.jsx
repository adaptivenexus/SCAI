...
const AccountControlsPage = () => {
  return (
    <div className="p-8 space-y-8">
      {/* Header Section and Warning Banner Side by Side */}
      <div className="flex items-center gap-8">
        ...
        {/* Warning Banner */}
        <div className="p-6 rounded-2xl bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 flex-shrink-0">
          <div className="flex items-center gap-3">
            <FiAlertTriangle className="w-6 h-6 text-orange-600" />
            <div>
              <h4 className="label-text font-semibold text-orange-800">
                Important Notice
              </h4>
              <p className="text-sm text-orange-700 mt-1">
                These actions will affect your account access and data. Please
              ...
              <div className="flex-1">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 text-sm text-secondary-foreground">
                    <div className="w-1.5 h-1.5 rounded-full bg-orange-500"></div>
                    <span>
                      Team members will lose access to your shared content
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-sm text-secondary-foreground">
                    <div className="w-1.5 h-1.5 rounded-full bg-orange-500"></div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-secondary-foreground mt-1">
              Contact our support team if you need assistance with account
              management or have questions about these actions.
            </p>
          </div>
        </div>
      </div>
