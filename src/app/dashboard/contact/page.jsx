                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full outline-none border-2 border-gray-200 focus:border-primary font-medium rounded-xl py-3 px-4 bg-white/50 backdrop-blur-sm transition-all duration-300 hover:border-primary/50 disabled:bg-gray-50 disabled:text-gray-500"
                          value={user?.name || ""} 
                          disabled
                        />
                      </div>
