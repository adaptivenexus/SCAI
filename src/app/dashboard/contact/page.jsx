                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full outline-none border-2 border-gray-200 focus:border-primary font-medium rounded-xl py-4 px-5 bg-white/50 backdrop-blur-sm transition-all duration-300 hover:border-primary/50 disabled:bg-gray-50 disabled:text-gray-500"
                          value={user?.name || ""} 
                          disabled
                        />
                      </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 overflow-hidden">
              <div className="bg-gradient-to-br from-accent-secondary/30 to-accent-primary/30 p-6">
                ...
                <ul className="space-y-3 text-sm text-secondary-foreground">
                  ...
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                    <span>Mention your agency name for faster support</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0"></div>
