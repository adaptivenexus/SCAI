...
export async function POST(req) {
  try {
    ...
    const emailContent = `
      ...
      <p style="color: #444; margin-bottom: 18px;">A document has been securely shared with you via SCANDOQ. Please click the below link to access it:</p>
      ...
      <p style="color: #444; margin-bottom: 0;">If you have any questions or did not expect this email, please contact us at <a href="mailto:business@adaptivenexus.com" style="color: #6C63FF; text-decoration: underline;">business@adaptivenexus.com</a>.</p>
